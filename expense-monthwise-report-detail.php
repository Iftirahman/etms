...
<head>
    ...
    <title>Expense Tracker || Monthwise Expense Report Details</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered dt-responsive nowrap" style="border-collapse:collapse;">
                                ...
                                <?php 
                                    ...
                                    $result = mysqli_query($conn, "SELECT month(expense_date) AS rptmonth,
                                    substring(
                                        concat('  January'
                                              ,' February'
                                              ,'    March'
                                         ...
                                         , 9 )as monthname, year(expense_date) AS rptyear, sum(cost) AS totalmonth 
                                ...
                                <tr>
                                    <td><?php echo $cnt; ?></td>
                                    <td><?php echo $row['monthname']."-".$row['rptyear'] ?></td>
